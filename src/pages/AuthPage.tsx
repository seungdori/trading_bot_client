  ...
  return (
    <>
      <div className="md:hidden">
        <img src={AuthPageLightImage} width={1280} height={843} alt="Authentication" className="block dark:hidden" />
        <img src={AuthPageDarkImage} width={1280} height={843} alt="Authentication" className="hidden dark:block" />
      </div>
